...
<div class="container">
    <!-- <div class="row justify-content-center">-->
         <div class="col-md-20">
            ...
            <br><br>
<form method="POST" action="{{ route('Liquidacion.Novprueba.pruebaDos') }}" >
         @csrf
        ...
        <div class="btn-group" role="group" aria-label="Basic example">
         ...
         <br>
         <div class="form-row">
            <label style="text-align:center" for="staticEmail" class="col-sm-2 col-form-label"><b><u> Articulo </b></u></label>
            <div class="col-sm-3">
         ...
         <br>
         <a href="{{route('liquidacion.Novprueba.verpdfNovPrueba',$colegio_id )}}" target="blank" class="btn btn-secondary">Ver en  PDF PLANILLA OTRA NOVEDAD</a>
         <br><BR>
...
<table class="table table-bordered " id="tablaAltaBaja" >
   <thead class="thead-dark">
           ...
           <th scope="col" style="width : 20%;"> Articulo </p></th>
   ...
   <tbody>
         ...
         <td>
            <form action="{{ route('liquidacion.novedadesDos',$item->id)}}" method="POST">
               @csrf 
